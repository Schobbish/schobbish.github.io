...
<head>
	...
	<link rel="stylesheet" href="/index/Slidebars/dev/slidebars.css">
	<link rel="stylesheet" href="/index/main.css">
	<link rel="stylesheet" href="page.css">
	<link rel="stylesheet" media="(max-width: 640px) and (orientation: portrait)" href="/index/phone-styles.css">
	<?php
	...
	<div id="fixed-navigation" canvas="">
		<nav>
			<a id="menu-button" href="">
				<img src="/index/images/triple-bars.png" alt="menu icon">
				Menu
			</a>
			<a href="/">
